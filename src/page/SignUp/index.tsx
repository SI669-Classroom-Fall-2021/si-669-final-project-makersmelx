  ...
  return (
    <Center flex={1}>
      <Box safeArea width="90%" height="100%">
        <Form space={6} submitButton={<Button isLoading={loading}>Sign Up</Button>} onFinish={onFinish}>
          <FormItem
            name="email"
            label="Email"
            defaultValue=""
          ...
          <FormItem
            ...
            helperText={['At least eight characters', 'At least one upper case letter, lower case letter and number']}
          >
            <PasswordInput />
          </FormItem>
          <FormItem
